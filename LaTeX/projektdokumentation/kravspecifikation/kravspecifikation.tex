...
Denne model benyttes til at sikre en målrettet projektudvikling. Hvert individuelt krav tildeles en prioritering, hermed kan opnås størst fokus på de mest systemkritiske krav, metoden er beskrevet nærmere i afsnit \ref{sec:moscow}. De ikke-funktionelle krav er arrangeret efter FURPS+ modellen og nærmere beskrevet i afsnit \ref{sec:furps}. 
...
I det følgende afsnit opstilles de funktionelle krav til systemet. Disse krav skal opfyldes for at systemet betragtes som fuldt funktionelt. Kravene listes med et unik ID således de kan spores tilbage igennem hele dokumentationen. Kravenes ID er opstillet efter følgende model:
...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{| m{1.5 cm} | Z | m{2.9 cm} |} \hline
		...
		UX\_03	& Brugeren skal kunne indstille en åbningstid for ventilen   						&	Den tid som ventilen er åben i, hver gang der vandes\\ \hline
		UX\_04	& Brugeren skal kunne vælge automatisk vandingstidsrum								&	Eks. morgen, aften, begge eller hele dagen \\ \hline
	\end{tabularx}
	\caption{Must krav}
	\label{tbl:must_krav}
\end{table}
