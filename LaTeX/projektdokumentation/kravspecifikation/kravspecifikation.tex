...
De ikke funktionelle krav til systemet opstilles efter FURPS+ modellen udviklet af Hewlett-Packard. \todo[inline]{find reference for FURPS+} Denne metode benyttes til at klassificere og administrere funktionelle og ikke-funktionelle krav, her benyttes modellen primært til håndtering af sidstnævnte.
...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{| m{1.5 cm} | Z | m{2.9 cm} |} \hline
		...
		RI\_03		 & Systemet skal ha en MTBF (MeanTime Between Failures) på ???			& \todo[inline]{lav måling}	\\ \hline
		RI\_04		 & System skal ha en MTTR (MeanTime To Restore) på ???					& \todo[inline]{lav måling} \\ \hline
	\end{tabularx}
...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{| m{1.5 cm} | Z | m{2.9 cm} |} \hline
		...
		PF\_04		 & Hvor mange instanser af systemet skal kunne køre samtidig			& \\ \hline
		PF\_05		 & Temperatur range (1-70 graderC)										& \\ \hline
		PF\_06		 & Målepræcision (5\%)													& \\ \hline
		PF\_07		 & Systemrespons fra brugerinteraktion til aktuator skal være 1<sek		& \\ \hline
