...
Denne model benyttes til at sikre en målrettet projektudvikling, og hvert individuelt krav tildeles en prioritering. Hermed kan opnås størst fokus på de mest systemkritiske krav, metoden er beskrevet nærmere i afsnit \ref{sec:moscow}. De Ikke-funktionelle krav er arrangeret efter FURPS+ modellen.
