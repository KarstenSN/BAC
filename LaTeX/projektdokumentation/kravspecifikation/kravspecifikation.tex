...
I det følgende afsnit opstilles de funktionelle krav til systemet. Disse krav skal opfyldes for at systemet betragtes som fuldt funktionelt. Kravende listes med et unik ID således de kan spores tilbage igennem hele dokumentationen. Kravenes ID er givet ved:
...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{| m{1.5 cm} | Z | m{2.9 cm} |} \hline
		\textbf{ID:} & \textbf{Krav:}														 & \textbf{Kommentarer:} 	\\ \hline
		MC\_02	& Systemet skal kunne pre-indstilles til en specifik afgrøde 	&	\\ \hline
		MC\_03  & Systemet skal kunne måle PH-værdien i jorden					&	\\ \hline
 	\end{tabularx}
	\caption{Could krav}
...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{| m{1.5 cm} | Z | m{2.9 cm} |} \hline
		\textbf{ID:} & \textbf{Krav:}														 & \textbf{Kommentarer:} 	\\ \hline
		MC\_03	& Systemet skal kunne betjenes fra en smartphone-applikation	&	\\ \hline
		MC\_04	& Systemet skal kunne tilsluttes flere sensorer					&	\\ \hline
	\end{tabularx}
	\caption{Would krav}
...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{| m{1.5 cm} | Z | m{2.9 cm} |} \hline
		...
		US\_09		 & Printplader til kontrolboks og sensor skal monteres i et plasthus med en størrelse på B:83mmm H:59mm, D:34mm						 & Ventil og jordfugtsensor må dog gerne stikke uden for plasthuset \\ \hline
	\end{tabularx}
