...
EL\_03	& Kontrolboksen skal kunne forsynes med en 3. parts AC/DC adaptor									& \textit{Must}	 & 	\\ \hline
...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{ m{1.5 cm}  Z  L{1.9 cm} m{2.9 cm} }
		...
		EL\_03	& Kontrolboksen skal kunne forsynes med en 3. parts AC/DC adaptor										\\
...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{| m{1.5 cm} | Z | m{2.9 cm} |} \hline
		...
		US\_03		 & Displayet skal kunne vise jordfugtighed, temperatur samt lysintesitet &	\todo[inline]{mangler vi mere her} \\ \hline
...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{| m{1.5 cm} | Z | m{2.9 cm} |} \hline
		...
		RI\_02		 & Systemfejlmelding skal vises på display 								& \todo[inline]{stadig?}\\ \hline
	\end{tabularx}
...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{| m{1.5 cm} | Z | m{2.9 cm} |} \hline
		...
		PF\_04		 & Flere instanser af systemet skal kunne køre samtidig					& \todo[inline]{hvor mange?}\\ \hline
		PF\_05		 & Temperatur range ($ 1-70 ^{\circ}C $)								& \\ \hline
		...
		PF\_08		 & Sensoren skal kunne måle temperatur med min. 1 decimals præcision	& \\ \hline
...
\todo[inline]{lave use case til parring af systemet (evt. i stedet for tænd/sluk UC'en.)}
