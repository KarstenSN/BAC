...
\begin{table}[H]
	\begin{tabularx}{\textwidth}{ m{1.5 cm}  Z  L{1.9 cm} m{2.9 cm} }
		...
		MC\_09	& Tastaturet må have maksimal mål på (B:70mmm H:23mm)													\\
		...
		CM\_03	& Sensor og kontrolboks skal parres manuelt 															\\
		...
		UX\_04	& Brugeren skal kunne indstille et ønsket vandingsinterval												\\
		UX\_05	& Brugeren skal kunne indstille en ønsket jordfugtighed på kontrolboksen								\\
		UX\_06	& Brugeren skal kunne indstille en tidsbaseret vandingssekvens											\\
		UX\_07	& Brugeren skal kunne vælge automatisk vandingstidsrum, eks. morgen, aften, begge eller uafhængig		\\
	\end{tabularx}
	\caption{Must krav}
	\label{tbl:must_krav}
\end{table}
