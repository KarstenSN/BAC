...
\begin{packed_enum}
	\item Brugeren trykker 2 gange på \texttt{SET} knappen på taststuret 
	\item Der vises nu hvad åbningstiden i forvejen er indstillet til
	\item Brugeren trykker nu enten på pil op eller pil ned for at stille åbningstiden op eller ned. Denne kan stilles i et interval fra 0-15 min
