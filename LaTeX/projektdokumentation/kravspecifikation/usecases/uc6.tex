...
\begin{packed_enum}
	...
	\item Teksten "\texttt{Open valve?}" fremkommer hvis der er trykket \texttt{Pil-op}. Er der trykket \texttt{Pil-ned} fremkommer vises teksten "\texttt{Close valve?}"
...
\textbf{{[}Ext 1 : Ventilen er allerede i den ønskede position{]}}
	\begin{packed_enum}\itemsep1pt \parskip0pt \parsep0pt
		\item Teksten "\texttt{Already open}" eller "\texttt{Already closed}" vises på display'et.				
	\end{packed_enum}
