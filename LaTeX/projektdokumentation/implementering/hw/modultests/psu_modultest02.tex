...
\todo[inline]{DETTE ER KOPI AF MODULTEST 1 (skal rettes når 02 udføres)}
...
\begin{tabularx}{\textwidth}{| L{3.3 cm} | Z |} \hline
	...
	\textbf{Dato \& tid:}			& -- -- --							\\ \hline
	\textbf{Udført af:}				& -- -- --							\\ \hline
...
Her er det interessant at se på målingerne ved $V_{IN}<2.8V $ da det primært er her at boostkonverteren kommer til at arbejde, samt at kravet PF\_03 skal være opfyldt.På Figur \ref{fig:modultest01_scope_05} på side \pageref{fig:modultest01_scope_05} ses at der ved $ R_{load}=100mA $ stadig står $3.3V$ på udgangen af konverteren.
