...
Valgtet af denne antenne og antennetype baserer sig på at udnytte pladsen på sensor-PCB'et bedst muligt for at kunne implementere den bedst mulige antenne. Dog skal det bemærkes  at denne antenne ved dens nuværende placering  og orientering på PCB'et når sensoren er placeret i jorden, fås at sensorboksen gerne skal rettes imod kontrolboksens placering for at opnå optimale gain. jfv. Figur \ref{fig:ant_maxGain_sensor}.
...
Den optimale placering af antennen på PCB'et ville være horisontalt jfv. Fig 3 i databladet, da dette giver den optimale udstråling langs langs med jorden (XY-planet). Men desværre muliggør pladsen på sensoren ikke dette. Derfor er antennen placeret hvor den er i denne iteration af sensoren.
