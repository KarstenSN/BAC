...
Den analoge temperaturføler blev designet først og før at kravet om I2C lå fast. Via en kurve som ses i Figur \ref{fig:tempkurve}. kan temperaturen aflæses. Ved at køre på mikroprocessorens interne 2.56V referenceforsyning, fås der en opløsning af ADC'en på:
