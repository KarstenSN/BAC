...
For en kapaciteten i en kondensator gælder:
...
Operationsforstærkerens passer med det gamle footprint og det var derfor nemt at erstatte den på printet. Men det viste sig at kredsløbet nu begyndte at oscillere se Figur \ref{fig:jnyopamp}. Det blev som før forsøgt at ændre størrelserne på komponentværdierne i filteret således C1 og C1 var 47pF. Dette hjalp intet. Det blev også forsøgt at ændre filterets Q ned til 5. Dette løste dog hellere ikke problemet. 
