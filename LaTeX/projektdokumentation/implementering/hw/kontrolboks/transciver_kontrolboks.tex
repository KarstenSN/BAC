...
<<<<<<< HEAD
Der er valgt at benytte en transceiver af typen MRFX49A\cite{lib:trans_MRFX49A_datasheet} fra Microchip, denne er valgt da den opfylder designkravene i afsnit \ref{designkrav:transceiver} på side \pageref{designkrav:transceiver} samt kravene i afsnit \ref{ch:kravspecifikation} fra side \pageref{ch:kravspecifikation}. Derudover skal denne kreds ikke forprogrammeres som mange andre RF-kredse skal, den kan derimod sættes op ved initialisering af mikroprocessoren som krævet af systemet. Transceiveren er som skræddersyet til dette system da den er designet til batteri-applikationer. Den har en indbygget "low battery voltage detection" som afgiver et interrupt til mikroprocessoren når batterispændingen når under et forudindstillet threshold, som sættes internt i transceiveren. Dette interrupt bliver brugt på sensoren til at enable boostkonverteren, mere info kan finde i implementeringsafsnittet for transceiveren på sensoren. Derudover har den også en indbygget wake-up timer således at transceiveren kan sættes i sleep-mode, herved minimeres strømforbruget til nogle få $\mu A$, den kan herefter vækkes op igen efter en forudindstillet tidsperiode. Transceiveren kan kommunikere ved 433/868/915 MHz og ligger derfor i et frekvens område som ofte benyttes i consumer-elektronik.. Endnu en fordel ved denne transceiver er at den bruger FSK modulation (\textbf{F}requency \textbf{S}hift \textbf{K}eying) hvor carrier-frekvensen moduleres i stedet for at modulere på amplituden (AM). Dette gør at rækkevidden forøges da signalet bliver mindre støjfølsomt. På Figur \ref{fig:mrfx49a_cir} ses applikationsdiagram fra databladet for Transceiveren.    
=======
...
>>>>>>> ae197e6a33b261985294f34775c0d6fa48c519af
