...
\textbf{F1}	\\
Fuseresistoren F1 sidder som primær sikring for kontrolboksen, da alt på printet, på nær motorventilen, forsynes herigennem. Den er valgt til en værdi på 250mA som udgangspunkt. Værdien bør udregnes mere præcist senere.

\textbf{F2}	\\
Fuseresistoren F2 sidder som sikring til motorventilen. Motorventilen trækker 100mA når den åbnes og lukkes. For at sikre en mindre belastning ikke vil sprænge sikringen vælges den til 1A. 
