...
\textbf{F1}	\\
Fuseresistoren F1 sidder som primær sikring for kontrolboksen, da alt på printet, på nær motorventilen, forsynes herigennem. Den er valgt til en værdi på 250mA, da  \todo[inline]{hvorfor denne væredi for fuse resistor}
