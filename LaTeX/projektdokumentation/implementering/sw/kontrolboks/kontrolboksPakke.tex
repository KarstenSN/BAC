...
Som det ses på Figur \ref{fig:kbpakke1} skal kontrolboks-pakken bestå af i alt 5 byte. To byte som tilsammen udgør et startword til \texttt{transceiver}. Et Id og et cheksum-word. 
