...
I Figur \ref{fig:class_rftransciver} ses et klassediagram over transceiveren. Koden er skrevet i C og det er derfor svært at give en korrekt beskrivelse af "klassen" som en klasse, da den er realiseret i en struct. Det vil sige at structen bliver oprettet med funktionspointere til alle public funktioner. Disse er markeret med + foran funktionen. Af private members er der sat - foran funktionen. Alle funktionerne er skrevet i en .c fil hvor structen er skrevet i en .h fil. Det er derfor kun muligt at se de funktioner som struction initieres med i init funktionen. Denne funktionen er en extern funktion da den ligger uden for structen og bliver kaldt med \texttt{rfTransceiver} som parameter. Funktionen giver pointere fra .c filen videre til structen. De private members er funktioner som kun kan ses af selve .c filen selv og disse funktioner kan derfor ikke ses i .h filen.  
