\section{Antenneberegninger}  \label{appendix:antenne}
...
Analisys and Design 3.ed" \cite{lib:balanis}. microstrip-antennen opbygges med "line feed" efter transmissionlinje-modellen som er den model der giver et hurtigt overblik over de fysiskeparametre, men dog er mindre præcis og er sværere at modellere kobling på. Men i første omgang ønske jo netop bare en formfaktor. 
