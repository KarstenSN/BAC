...
Til første iteration af kontrolboksen blev det valgt at benytte en through-hole monteret helical-antenne, dette valg blev truffet på baggrund af ønsket om en quick and dirty løsning til at komme hurtigt igang. En antenne af typen W3127 ISM 433MHz fra \textit{Pulse Electronics} blev benyttet. Denne antenne er den mest isotropiske af kandidaterne med en Max Gain på $ G_{max}=-2.9 dBi$. jvf. Fig 3 i databladet \cite{lib:ant_W3127_datasheet}
