...
\subsection{Boost konverter beregninger} \label{sec:psu_beregninger}
...
\paragraph{Sensor ver3}

\todo[inline]{skriv note om nyt layout ver3}
...
\todo[inline]{indsæt psu-modultest02 (ver3) når denne er klar.}
