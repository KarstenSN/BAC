...
De resterende beregniner for $ \Delta I_{L} $ og $ D_{max} $ findes i Appendix \ref{appendix:psu}. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%				BOOST KONVERTER MODULTEST
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{Boost konverter modultest} \label{sec:psu_modultest}

\input{hwimplementering/modultests/psu_modultest01}

Denne test er som nævnt en modultest foretaget med anbefalede værdier fra databladet og ikke du beregnede værdier fra afsnit \ref{sec:psu_beregninger}. Denne test kan ses foretaget herunder.

\todo[inline]{indsæt psu-modultest02 når denne er klar.}
