...
\subsubsection{Load af jordspyd}
...
Her er indført en MOSFET-transistor, Q11 således at mikroprocessoren kan tænde og slukke for et separat måle-groundplan. Dette er gjort af strømbesparende årsager. Hermed kan der lukkes ned for hele målerkredsløbet når sensoren lægges i sleep-mode. I mikroprocessoren er der en automatisk kalibreringsfunktion som køres ved tryk på Connect-knappen. \todo[inline]{Ændring af alle henvisninger fra RESET-knap til Connect} Spændingsfølgeren på indgangen er fjernet da den viste sig overflødig. Selvom at R22 ikke er ideelt 
...
\begin{figure}[H]
	...
	\caption{Stigetiden fra 20pF til 220pF.}
	\label{fig:j19}
\end{figure} 
