...
\subsubsection{C26}
Da der kun ønskes at kunne detektere en faseforskydelse på maksimalt $90^\circ$, er der som det sidste led designet placeret en ikke inverterende forstærkerkobling med en forstærkning på $A=2$, dette er gjort for at få fuld dynamisk range. På Figur \ref{fig:j8} ses et plot af udgangsspændingen vs. kapaciteten af C26.    
