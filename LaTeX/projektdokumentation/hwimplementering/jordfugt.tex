...
Her er indført en MOSFET-transistor, Q11 således at mikroprocessoren kan tænde og slukke for et separat måle-groundplan.  Herved kan der lukkes ned for hele målerkredsløbet når sensoren lægges i sleep-mode. I mikroprocessoren er der en automatisk kalibreringsfunktion som køres ved tryk på Connect-knappen. \todo[inline]{Ændring af alle henvisninger fra RESET-knap til Connect} Spændingsfølgeren på indgangen er fjernet da den viste sig overflødig. Selvom at R22 ikke er 22k$\Omega$ giver 33k$\Omega$ ikke den store forskel. R22 er ændret til 33k$\Omega$ da forstærkningen er sænket til 1. 
