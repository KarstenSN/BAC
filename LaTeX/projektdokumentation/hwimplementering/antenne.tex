...
Følgende parametre kan opstilles for systemet, her antages det at udstrålingseffektiviteten $ e_{t} $ og $ e_{r} $ for transmitter og receiver sættes til $ 0.9 $. Dette er optimistisk sat, men det er grundet et ønske om at få en målestok for antennens maksimale rækkevidde. 
...
\begin{align} \label{eq:ant_R}
	R = \sqrt{ e_{t}   \frac{P_{t} D_{t}(\theta_{t},\phi_{t})} {4 \pi P_{r}} \times e_{r} D_{r}(\theta_{r},\phi_{r}) \frac{\lambda^{2}}{4 \pi}}
\end{align}
