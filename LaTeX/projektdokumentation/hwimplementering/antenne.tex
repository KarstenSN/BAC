...
Til sensoren er valgt at anvende en through-hole monteret helical antenne af typen W3127 ISM 433MHz fra \textit{Pulse Electronics}. Denne antenne er den mest isotropiske af kandidaterne med en Max Gain på $ G_{max}=-2.9 dBi$. jvf. Fig 3 i databladet i bilag. \cite{lib:ant_W3127_datasheet}. Dette valgt baserer sig på at udnytte pladsen på sensor-PB'et mest muligt for at kunne implementere den bedst mulige antenne, samt at denne antenne ved dens placering  og orientering på PCB'et når PCB'ets er placeret i jorden gør at der ydes optimal udstråling. 
