...
Følgende krav testes seperat hvis disse er implementeret. 

\textbf{CM\_03} \textit{Should} Kommunikation fra sensor til kontrolboks skal virke ved minimum 30m. \\ 
Testes ved gennemførelse af UC8 ved en afstand mellem kontrolboks og sensor på 30m.  Kravet er ikke opfyldt da den maksimale afstand er ca 10m.
