...
Det er valgt at systemet skal kunne benytte 3.parts AC/DC Power Supplies. Følgende krav skal opfyldes til denne eksterne power Supply. 

\begin{itemize}
	\setlength\itemsep{0em}	
	\item	Den skal kunne levere en udgangsspænding på 5VDC $\pm 10\%$
	\item	Den skal kunne levere en udgangsstrøm på min. 1A
	\item	Sekundærside-konnekteren skal være en 6.50Ø $\pm 2mm$ DC jack-konnekter med 2.50Ø mm $\pm 2mm$ center pin  
\end{itemize}

Strømforsyningen på kontrolboksen skal inkludere en 6.50Ø $\pm 2mm$ DC jack-konnekter med 2.5 mm center pin. Denne skal have en maksimum rated input current på min. 2A. For at sikre kontrolboksen optimalt skal strømforsyningen indeholde ESD-beskyttelse, beskytte mod omvendt-polarisation samt strøm-overforbrug. Strømforsyning skal kunne acceptere 5VDC $\pm 10\%$ inputspænding fra den eksterne power supply. Derudover skal den indeholde en spændingsregulator ned til 3.3VDC $\pm 10\%$ på udgangssiden. Kravene til Strømforsyningen på kontrolboksen kan samles til følgende: 

\begin{itemize}
	\setlength\itemsep{0em}
	\item 	Strømforsyningen skal have en 6.50Ø $\pm 2mm$ DC jack-konnekter med 2.5 mm center pin
	\item 	Strømforsyningen skal have en maksimum rated input current på min. 2A
	\item 	Strømforsyningen skal ESD-beskyttelse
	\item 	Strømforsyningen skal indeholde beskyttelse imod omvendt polarisation
	\item 	Strømforsyningen skal indeholde beskyttelse imod strøm overforbrug
	\item 	Strømforsyning skal kunne acceptere 5VDC $\pm 10\%$ inputspænding på DC jack-konnekter
	\item 	Strømforsyningen skal indeholde 5VDC-3.3VDC spændingsregulator	
\end{itemize}
...
Mikroprocessoren er den samme som i kontrolboksen, derfor henvises til afsnit \ref{designkrav:mikroprocessor} på side \pageref{designkrav:mikroprocessor}.
