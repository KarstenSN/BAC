...
HF-Transceiveren skal kommunikere med mikroprocessoren via SPI. Den skal inkludere en antenne som skal indbygges i kontrolboksen.




% Krav til kommunikation
% Krav til Frekvens - unlicensed 433 MHz
% Krav til Datarate - 16 bytes pr. sekund (størstedatapakke) + responstid
% Krav til Antenne
