...
\begin{figure}[H]
	\centering
   \includegraphics[width=0.7\textwidth]{../fig/Jordfugt/diagram1.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{../fig/Temperatur/temp_i2c.png}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.4\textwidth]{../fig/rapport/antenne_helical.png}
  \caption{Antennen i sensoren}
  \label{fig:helant}
\end{figure}
