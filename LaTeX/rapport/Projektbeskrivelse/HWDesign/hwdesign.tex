...
Da det begyndte at knibe med tiden blev der derfor implementeret en løsning som i starten var valgt fra pga. dens dårlige støj og temperatur forhold. Se sektion \ref{P-sec:HWimp_jordfugt}: \nameref{P-sec:HWimp_jordfugt} side \pageref{P-sec:HWimp_jordfugt} i projektdokumentationen og Figur \ref{fig:jdig1} herunder.
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.2\textwidth]{../fig/Lysmaeler/diagram.png}
