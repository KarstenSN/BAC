...
Udvidelserne af systemet med pH-måler og specifikke afgrøder kræver at der programmeres en database til at holde det information som systemet skal basere sine valg på. Dette er derfor ikke planer om at implementere på nuværende tidspunkt. Jvf. krav \textbf{MC\_07} i afsnit \ref{P-sec:funktionelle_krav}: \nameref{P-sec:funktionelle_krav} på side \pageref{P-sec:funktionelle_krav} i projektdokumentation og i tabel \ref{tbl:funk_krav} på side \pageref{tbl:funk_krav} her i Rapporten.

\textbf{Fejlhåndtering ved slangeafkobling} \newline
Det skal også implementeres en fejlhåndtering således at systemet selv lukke for ventilen hvis slange er sprunget fra, således at der ikke unødvendigt spildes vand. Jvf. krav \textbf{UX\_05} i afsnit \ref{P-sec:funktionelle_krav}: \nameref{P-sec:funktionelle_krav} på side \pageref{P-sec:funktionelle_krav} i projektdokumentation og i tabel \ref{tbl:funk_krav} på side \pageref{tbl:funk_krav} her i Rapporten.
