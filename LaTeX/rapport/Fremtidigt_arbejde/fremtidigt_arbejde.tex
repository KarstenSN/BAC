...
Eftersom at der i dette projekt kun er udviklet en prototype er der derfor stadig en del arbejde. Der skal laves EMC test og der skal laves 3D modeller til plasthuse osv. Disse opgaver opstilles herunder.

\textbf{Jordfugtmåler}\\
Kredsløbet til måling af faseændring skal færdigudvikles således at dette kan erstatte det nuværende målingskredsløb. Dette er planlagt til implementering i iteration 2.
...
For at spare produktionsomkostningerne og give brugeren en bedere grænseflade skal der udvikles en smartphone app. Jvf. krav \textbf{MC\_08} i afsnit \ref{P-sec:funktionelle_krav}: \nameref{P-sec:funktionelle_krav} på side \pageref{P-sec:funktionelle_krav} i projektdokumentation og i tabel \ref{tbl:funk_krav} på side \pageref{tbl:funk_krav} her i Rapporten.
...
Udvidelserne af systemet med pH-måler og specifikke afgrøder kræver at der programmeres en database til at holde det information som systemet skal basere sine valg på. Jvf. krav \textbf{MC\_07} i afsnit \ref{P-sec:funktionelle_krav}: \nameref{P-sec:funktionelle_krav} på side \pageref{P-sec:funktionelle_krav} i projektdokumentation og i tabel \ref{tbl:funk_krav} på side \pageref{tbl:funk_krav} her i Rapporten.

\textbf{Specifik afgrøde} \newline
Et sted hvor systemet yderligere kan optimeres på sin funktionalitet, er muligheden for at indstille systemet til en specifik afgrøde. Således kan systemet optimere grobetingelserne informere brugeren om eventuelt mangel på næringsstoffer. Til dette kræves en pH-måling af jorden. Jvf. krav \textbf{MC\_06} i afsnit \ref{P-sec:funktionelle_krav}: \nameref{P-sec:funktionelle_krav} på side \pageref{P-sec:funktionelle_krav} i projektdokumentation og i tabel \ref{tbl:funk_krav} på side \pageref{tbl:funk_krav} her i Rapporten.

\textbf{Fejlhåndtering ved slangeafkobling} \newline
Der skal også implementeres en fejlhåndtering således at systemet selv lukke for ventilen hvis slange er sprunget fra, således at der ikke unødvendigt spildes vand. Jvf. krav \textbf{UX\_05} i afsnit \ref{P-sec:funktionelle_krav}: \nameref{P-sec:funktionelle_krav} på side \pageref{P-sec:funktionelle_krav} i projektdokumentation og i tabel \ref{tbl:funk_krav} på side \pageref{tbl:funk_krav} her i Rapporten.
