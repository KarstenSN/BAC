\section{Udviklingsomkostninger og mulig indtjening} \label{sec:produktion}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{../fig/rapport/forretningsmodel/plc.png}
...
Det har igennem udviklingen været et krav at systemet skulle designes billigst muligt, samtidig med at en god kvalitet skulle opretholdes. Derfor har det fra starten været ønsket at tænke DFM (Design For Manufacturability) ind som en integreret del af designprocessen. DFM indebærer at udvikle sit design så det bedst muligt egner sig til produktion samt reducerer omkostninger hertil. Derudover handler det om at foregribe evt. produktionsmæssige udfordringer allerede i designfasen, hvor de slår mindst igennem på omkostningerne. Der er mange lag og overvejelser i forbindelse med DFM og her vil blive gennemgået nogle af dem som projektgruppen har fundet til at ha størst betydning for dette projekt.
For at holde produktionsomkostningerne lave i forbindelse med printfremstilling er der i størst muligt omfang forsøgt at undgå håndmontage og derfor er flest mulige komponenter implementeret som SMD. Dog er der få komponenter som ikke kan monteres som SMD og derfor skal håndmonteres. Her er der tale om display'et, tastaturet og selve ventilen som skal påmonteres kontrolboksen. Ved PCB-udlægningen er følgende IPC-standarderne \textit{2221A}, \textit{7351} samt \textit{7251} fulgt for at opnå bedst muligt kvalitetssikring samt minimere risikoen for fejl, Ligesom der er lagt tid i at opsætte de korrekt contraints i forbindelse med PCB-udlæg. \newline
Selve teknologien til jordfugtmåling har også en betydning for prisen. Den resistive målemetode benytter to spyd stukket ned i jorden. Den kapacitive derimod kan blot laves ved at forlænge printpladen og herved spare omkostninger til montage og produktion af jordspyd. \newline
Et andet punkt hvor mange fejl kan foregribes er ved at sikre at ha tolerancerne i orden på sine komponenter, det være sig elektriske såvel som mekaniske komponenter. På denne måde sikres at  eks. PCB'er passer i deres plasthuse og at de elektriske kredsløb fungerer som forventet selvom der er udsving i komponenterne. Her er det værd at bemærke at der til, eks. Antenne-balunen, som er et kredsløb der er meget følsomt for komponentvariationer, bør benyttes komponenter af lav tolerance for at sikre en karakteristisk impedans så tæt på $50 \Omega$ som muligt. Andre kredsløb som eks. båndpasfiltre og feedback-kredsløb kan også have deres egne krav om maksimale tolerancer.
...
Hvordan leveres produktet? Dette gøres ved at kunden køber produktet på en webshop, som efterfølgende leveres med post. Her har kundeoplevelsen og kundetilfredshed højeste prioritet. Ofte er folk ikke hjemme når posten kommer og at hente pakken i et givent posthus åbningstid kan ofte være en besværlig process. Derfor er det vigtigt at give kunden muligheden får at få leveret pakken i en Swip-Box eller lignende, hvor kunden kan hentet pakken når det passer ind i hans tidsplan. Fragten skal være gratis.

\textbf{Key Activities}\\
Hvordan gøres det? Det gøres ved at lave et produkt som er billigere end konkurrenternes samtidig med det er bedre. Dertil kommer at kundeservice skal have høj prioritet, således at kunden får en god oplevelse med handlen selvom der mod forventning skulle gå noget galt. Eksempelvis, hvis en kunde modtager et defekt produkt skal det, uden omkostninger kunne returneres og et nyt fremsendes uden beregning. Produktet tænkes solgt igennem en selvejet webshop, hvilket vil minimerer omkostningerne til diverse mellemled i salget. 
...
Det ses at ved at gennemløbe Business model canvas, at det er muligt at lave en forretning. Dog kræver det at produktionsomkostningerne kommer længere ned end hvad de er ved den nuværende prototype. Produktet skal samtidig kunne slå konkurrenterne på funktionalitet hvilket det ikke gør nu. Se sektion \ref{sec:marked} for markedsundersøgelse. Her ses det at Gardenas Smartsystem er mere moderne da det kan betjenes med en smartphone. Det vurderes derfor at der skal udvikles en app således dette system kan betjenes via en smartphone og at det med fordel kan forbindes til internettet (IOT) således brugeren vil kunne følge systemet selvom at han ikke er hjemme. Der er fundet frem til at Texas Instruments har lavet en dualband Sub-1-GHz og bluetooth transceiver \textbf{CC1350} som ville kunne bruges til dette. Da transceiveren er dualband kan systemet få alle fordelene både ved nem opsætning via smartphone og samtidig bevare en lang rækkevidde til sensoren. Transceiveren indeholder også en DC/DC boostconverter, temperaturføler, ADC samt WDT. Dette gør at der kan spares en del på eksterne komponenter og da betjeningen sker via en smartphone kan omkostninger til display og keypad også udelukkes. Det er derfor nødvendigt at redesigne systemet.
