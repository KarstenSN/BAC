...
\subsection{forretningsvurdering}
Det ses ved gennemgang af Business Model Canvas, at det er muligt at lave en forretning. Dog kræver det at produktionsomkostningerne kommer længere ned end hvad de er ved den nuværende prototype. Produktet skal samtidig kunne slå konkurrenterne på funktionalitet hvilket det ikke gør nu. Se sektion \ref{sec:marked} for markedsundersøgelse. Her ses det at Gardenas Smartsystem er mere moderne da det kan betjenes via en smartphone. Det vurderes derfor at der skal udvikles en App således dette system opnår samme funktionalitet og at det med fordel kan forbindes til internettet (IOT) således at kunden vil kunne følge systemet selvom at denne ikke er hjemme, dette er beskrevet i Sektion \ref{ch:Fremtidigt_arbejde}: \nameref{ch:Fremtidigt_arbejde} på side \ref{ch:Fremtidigt_arbejde}.
