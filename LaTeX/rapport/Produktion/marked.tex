...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.2\textwidth]{../fig/rapport/markedsundersogelse/sensotimer.png}
	\caption{SensoTimer}
	\label{fig:mu_1}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.3\textwidth]{../fig/rapport/markedsundersogelse/mastercontrol.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\textwidth]{../fig/rapport/markedsundersogelse/smartsystem.png}
	\caption{Gardena Smart System}
	\label{fig:mu_3}
\end{figure}

Det ses at der i forvejen er konkurrerende systemer på marked. Dette er i sig selv godt da det viser at der er netop er et marked. Det ses også at prisen for et sådan system er forholdsvist høj og at der her er en parameter at konkurrere på. Selvom at produktet sælges til en lavere pris skal det samtidig også have en bedere eller tilsvarende funktionalitet. Her er Gardenas Smart System det system som der tilbyder mest og det vurderes at det er nødvendigt at inkludere en smartphone applikation til styring af systemet. Prisen vurderes til at må ligge på maksimalt 500kr.   