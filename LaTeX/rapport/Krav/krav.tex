...
For at se den komplette beskrivelse af kravene for systemet henvises til kapitel 2 kravspecifikation i dokumentationen.

\begin{itemize} \itemsep0mm
	\item \textbf{UC1: Tænd system} sørger for opstart af systemet.
	\item \textbf{UC2: Aflæs fugtighed og temperatur} sørger for aflæsning af fugtighed og temperatur fra sensoren
	\item \textbf{UC3: Indstil ønsket fugtig} benyttes til, på kontrolboksen at indstille den ønskede fugtighed i det medie hvor sensoren er placeret 
	\item \textbf{UC4: Indstil åbningstid} giver brugeren mulighed for at indstille hvor længe der skal vandes ad gangen
	\item \textbf{UC5: Indstil vandingsinterval} giver brugeren mulighed for at indstille intervallet imellem vandingerne
...
MC\_09	& Systemet skal kunne tilsluttes flere sensorer														& \textit{Would} \\ \hline
...
De ikke-funktionelle krav findes i Kapitel 2 Kravspecifikation i dokumentationen.
