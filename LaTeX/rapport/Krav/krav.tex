...
For at se den komplette beskrivelse af kravene for systemet henvises til \ref{P-ch:kravspecifikation} \nameref{P-ch:kravspecifikation} på side \pageref{P-ch:kravspecifikation} i dokumentationen.
...
\begin{itemize} \itemsep0mm
	...
	\item \textbf{UC3: Indstil ønsket fugtig} benyttes til, på kontrolboksen at indstille den ønskede fugtighed i det medie hvori sensoren er placeret
